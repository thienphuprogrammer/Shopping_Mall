...
import static shoppingmall.utils.OutputUtil.printLineSeparate;
import static shoppingmall.utils.OutputUtil.printValueMenu;
...
public class AdminView {
    ...
    public static int getAdMinChoice() {
        ...
        printValueMenu("Nhập " + MENU_ADMIN_SHEET.ADD_PRODUCT.ordinal() + " để them san pha,.");
...
// System.out.print("ID user: " + id + " ".repeat(9 -
...
// System.out.println("items" + productName + "be found. You may want to delete?
// (Y/N)");
...
// loadListUser("src/Data/customer.bin");
